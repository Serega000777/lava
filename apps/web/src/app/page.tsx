  ...
  return (
    <main>
      <header className="nav">
        ...
        <div className="actions"><Link className="button-link ghost" href="/analytics">Аналитика</Link><Link className="button-link ghost" href="/messages">Сообщения</Link><Link className="button-link ghost" href="/favorites">Избранное</Link><Link className="button-link ghost" href="/login">Войти</Link><Link className="button-link" href="/listings/new">Разместить объявление</Link></div>
      </header>
